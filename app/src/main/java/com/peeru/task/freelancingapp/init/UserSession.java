package com.peeru.task.freelancingapp.init;
...
import com.peeru.task.freelancingapp.ui.activity.UserLogin;
...
public class UserSession {
    ...
    public static final String PREFER_NAME = Constant.FREELANCING_APP;
